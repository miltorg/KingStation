...
MSG_HASH(
   ...
   "Généralement défini par les développeurs qui compilent les applications libretro/KingStation pour pointer vers des assets."
   )
MSG_HASH(
