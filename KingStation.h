...
#define RETRO_ENVIRONMENT_KingStation_START_BLOCK 0x800000

#define RETRO_ENVIRONMENT_SET_SAVE_STATE_IN_BACKGROUND (2 | RETRO_ENVIRONMENT_KingStation_START_BLOCK)
                                            /* bool * --
                                            * Boolean value that tells the front end to save states in the
                                            * background or not.
                                            */

#define RETRO_ENVIRONMENT_GET_CLEAR_ALL_THREAD_WAITS_CB (3 | RETRO_ENVIRONMENT_KingStation_START_BLOCK)
                                            /* retro_environment_t * --
...
#define RETRO_ENVIRONMENT_POLL_TYPE_OVERRIDE (4 | RETRO_ENVIRONMENT_KingStation_START_BLOCK)
                                            /* unsigned * --
...
int KingStation_get_capabilities(enum rarch_capabilities type,
      char *s, size_t len);

void KingStation_override_setting_set(enum rarch_override_setting enum_idx, void *data);

void KingStation_override_setting_unset(enum rarch_override_setting enum_idx, void *data);

bool KingStation_override_setting_is_set(enum rarch_override_setting enum_idx, void *data);
...
bool KingStation_apply_shader(enum rarch_shader_type type, const char *preset_path,
      bool message);
 ...
 * runloop_iterate:
 *
 * Run Libretro core in KingStation for one frame.
 *
