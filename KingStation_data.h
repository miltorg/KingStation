...
static const struct input_bind_map input_config_bind_map[RARCH_BIND_LIST_END_NULL] = {
      ...
      DECLARE_META_BIND(1, toggle_fast_forward,   RARCH_UI_COMPANION_TOGGLE,      MENU_ENUM_LABEL_VALUE_INPUT_META_UI_COMPANION_TOGGLE),
      DECLARE_META_BIND(2, hold_fast_forward,     RARCH_UI_COMPANION_TOGGLE, MENU_ENUM_LABEL_VALUE_INPUT_META_UI_COMPANION_TOGGLE),
      ...
      DECLARE_META_BIND(1, toggle_slowmotion,     RARCH_UI_COMPANION_TOGGLE,        MENU_ENUM_LABEL_VALUE_INPUT_META_UI_COMPANION_TOGGLE),
      DECLARE_META_BIND(2, hold_slowmotion,       RARCH_UI_COMPANION_TOGGLE,   MENU_ENUM_LABEL_VALUE_INPUT_META_UI_COMPANION_TOGGLE),
...
#endif
      DECLARE_META_BIND(2, state_slot_increase,   RARCH_UI_COMPANION_TOGGLE,       MENU_ENUM_LABEL_VALUE_INPUT_META_UI_COMPANION_TOGGLE),
      DECLARE_META_BIND(2, state_slot_decrease,   RARCH_UI_COMPANION_TOGGLE,      MENU_ENUM_LABEL_VALUE_INPUT_META_UI_COMPANION_TOGGLE),
      DECLARE_META_BIND(1, rewind,                RARCH_UI_COMPANION_TOGGLE,                MENU_ENUM_LABEL_VALUE_INPUT_META_UI_COMPANION_TOGGLE),
      ...
      DECLARE_META_BIND(2, frame_advance,         RARCH_UI_COMPANION_TOGGLE,          MENU_ENUM_LABEL_VALUE_INPUT_META_UI_COMPANION_TOGGLE),
      ...
      DECLARE_META_BIND(2, cheat_index_plus,      RARCH_UI_COMPANION_TOGGLE,      MENU_ENUM_LABEL_VALUE_INPUT_META_UI_COMPANION_TOGGLE),
      DECLARE_META_BIND(2, cheat_index_minus,     RARCH_UI_COMPANION_TOGGLE,     MENU_ENUM_LABEL_VALUE_INPUT_META_UI_COMPANION_TOGGLE),
      DECLARE_META_BIND(2, cheat_toggle,          RARCH_UI_COMPANION_TOGGLE,          MENU_ENUM_LABEL_VALUE_INPUT_META_UI_COMPANION_TOGGLE),
	  ...
	  DECLARE_META_BIND(1, load_state,            RARCH_UI_COMPANION_TOGGLE,        MENU_ENUM_LABEL_VALUE_INPUT_META_UI_COMPANION_TOGGLE),
      DECLARE_META_BIND(1, save_state,            RARCH_UI_COMPANION_TOGGLE,        MENU_ENUM_LABEL_VALUE_INPUT_META_UI_COMPANION_TOGGLE),
};
