...
install: $(TARGET)
	...
	cp com.libretro.KingStation.appdata.xml $(DESTDIR)$(DATA_DIR)/metainfo
	...
	chmod 644 $(DESTDIR)$(DATA_DIR)/metainfo/com.libretro.KingStation.appdata.xml
...
uninstall:
	...
	rm -f $(DESTDIR)$(DATA_DIR)/metainfo/com.libretro.KingStation.appdata.xml
