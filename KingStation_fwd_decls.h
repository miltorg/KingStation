...
static void KingStation_deinit_drivers(struct rarch_state *p_rarch);
...
static void KingStation_deinit_core_options(struct rarch_state *p_rarch);
...
#ifdef HAVE_OVERLAY
static void KingStation_overlay_init(struct rarch_state *p_rarch);
static void KingStation_overlay_deinit(struct rarch_state *p_rarch);
